        ...
        <li>
            ...
            <div className={sideMenuState ? styles.activeSideMenu : styles.sideMenu}>
              ...
              <div className={styles.sideMenuImgGrid}> 
                <img className={styles.sideMenuImgGridItem} src={sidebarImage1} alt="side bar image 1" />
                <img className={styles.sideMenuImgGridItem} src={sidebarImage2} alt="side bar image 2" />
                <img className={styles.sideMenuImgGridItem} src={sidebarImage3} alt="side bar image 3" />
                <img className={styles.sideMenuImgGridItem} src={sidebarImage4} alt="side bar image 4" />
                <img className={styles.sideMenuImgGridItem} src={sidebarImage5} alt="side bar image 5" />
                <img className={styles.sideMenuImgGridItem} src={sidebarImage6} alt="side bar image 6" />
                <img className={styles.sideMenuImgGridItem} src={sidebarImage7} alt="side bar image 7" />
                <img className={styles.sideMenuImgGridItem} src={sidebarImage8} alt="side bar image 8" />
              </div> 
