...
import img1 from '../../img/products/item1/header/img1.png';
import img2 from '../../img/products/item1/header/img2.png';
import img3 from '../../img/products/item1/header/img3.png';
import img4 from '../../img/products/item1/header/img4.png';
import img5 from '../../img/products/item1/header/img5.png';
...
import Nikole from '../../img/products/item1/Nikole.png';
    ...
    <>
      <div className={styles.itemHeader}>
        ...
        <div className={styles.rightHeader}>
          ...
          <p className={styles.rightHeaderPrice}>$160</p>
        ...
        <div className={reviewLinkState ? styles.reviews : styles.hiddenDiv}>
          ...
          <div className={styles.commentDiv}>
            ...
            <div className={styles.commentContent}>
              ...
              <p className={styles.commentName}>Nikole Burke - 08.02.2023</p>
              <p className={styles.commentText}>Very good!</p>
            </div>
          </div>
