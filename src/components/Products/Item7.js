...
import img1 from '../../img/products/item7/img1.png';
import img2 from '../../img/products/item7/img2.png';
import img3 from '../../img/products/item7/img3.png';
import img4 from '../../img/products/item7/img4.png';
import img5 from '../../img/products/item7/img5.png';
      ...
      <div className={styles.itemHeader}>
        ...
        <div className={styles.rightHeader}>
          ...
          <p className={styles.rightHeaderPrice}>
            <s style={{fontSize:'1rem', color:'gray', paddingRight:'10px'}}>$30</s>
            $24
          </p>
