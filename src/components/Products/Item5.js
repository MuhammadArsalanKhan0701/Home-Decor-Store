...
import img1 from '../../img/products/item5/img1.png';
import img2 from '../../img/products/item5/img2.png';
import img3 from '../../img/products/item5/img3.png';
import img4 from '../../img/products/item5/img4.png';
import img5 from '../../img/products/item5/img5.png';
    ...
    <>
      <div className={styles.itemHeader}>
        ...
        <div className={styles.rightHeader}>
          ...
          <p className={styles.rightHeaderPrice}>$90</p>
