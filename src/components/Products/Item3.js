...
import img1 from '../../img/products/item3/img1.png';
import img2 from '../../img/products/item3/img2.png';
import img3 from '../../img/products/item3/img3.png';
import img4 from '../../img/products/item3/img4.png';
import img5 from '../../img/products/item3/img5.png';
...
import Ralph from '../../img/products/item3/ralph.png';
    ...
    <>
      <div className={styles.itemHeader}>
        ...
        <div className={styles.rightHeader}>
          ...
          <p className={styles.rightHeaderPrice}>$15</p>
